...
from app.schemas.opportunite import OpportuniteCreate, OpportuniteRead
from app.crud.opportunite import create_opportunite, get_opportunites, get_opportunite, delete_opportunite
